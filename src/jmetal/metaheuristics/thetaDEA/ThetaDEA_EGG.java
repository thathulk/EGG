...
public class ThetaDEA_EGG extends Algorithm {
	...
	public ThetaDEA_EGG(Problem problem,int run) {
		super(problem);
		t=run;
	} // ThetaDEA 
	...
	public SolutionSet execute() throws JMException, ClassNotFoundException {
		...
		while (evaluations_<maxEvaluations){
		    ...
		    else//if(front.size()<problem_.getNumberOfObjectives())
			...
			//population_.printObjectivesToFile("G:\\DRER_Analysis1\\0.2_0.7\\thetaDEA_"+problem_.getName()+"_"+problem_.getNumberOfObjectives()+"_T"+t+"fes"+evaluations_);
		}
		Ranking ranking = new NondominatedRanking(population_);
