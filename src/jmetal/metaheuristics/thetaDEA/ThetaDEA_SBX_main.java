...
public class ThetaDEA_SBX_main {
	public static void main(String args[]) throws JMException, ClassNotFoundException{
	    ...
	    for(int fun=1;fun<=1;fun++){
			...
			for(int i=0;i<runtimes;i++){
				...
				algorithm = new ThetaDEA_SBX(problem);
				...
				population.printObjectivesToFile("results\\thetaDEA_SBX\\thetaDEA_"+problem.getName()+"_"+problem.getNumberOfObjectives()+"_"+"T"+(i+1));
			}//for runtimes
