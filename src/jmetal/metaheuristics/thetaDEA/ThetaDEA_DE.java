...
public class ThetaDEA_DE extends Algorithm {
	...
	public ThetaDEA_DE(Problem problem) {
		super(problem);
	} // ThetaDEA 
	...
	void doCrossover(int i) throws JMException{
		...
		Solution child = (Solution) crossover_.execute(new Object[]{population_.get(i), parents});
