...
public class NSGAIII_EGG_main {
	public static void main(String args[]) throws JMException, ClassNotFoundException, SecurityException, IOException{
		...
		algorithm = new NSGAIII_EGG(problem);
...
//		crossover = CrossoverFactory.getCrossoverOperator("SBXCrossover",parameters);
		...
		population.printObjectivesToFile("results\\NSGA3_EGG\\NSGA3_"+problem.getName()+"_"+problem.getNumberOfObjectives()+"_"+"T"+(i+1));
		}
