...
import jmetal.problems.UF.UF10;
import jmetal.problems.UF.UF2;
import jmetal.problems.UF.UF3;
import jmetal.problems.UF.UF4;
import jmetal.problems.UF.UF5;
import jmetal.problems.UF.UF6;
import jmetal.problems.UF.UF7;
import jmetal.problems.UF.UF8;
import jmetal.problems.UF.UF9;
	...
	public static void main(String args[]) throws JMException, ClassNotFoundException{
	    ...
	    for(int fun=1;fun<=1;fun++){
			...
			for(int i=0;i<runtimes;i++){
				...
				algorithm = new MOEAD_EGG(problem);
				...
				population.printObjectivesToFile("results\\MOEAD_EGG\\MOEAD_"+problem.getName()+"_"+problem.getNumberOfObjectives()+"_"+"T"+(i+1));
			}//for runtimes
