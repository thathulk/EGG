 ...
 */
public class SPEA2_SDE_SBX_main {
	public static void main(String [] args) throws JMException, IOException, ClassNotFoundException {
		...
		for(int fun=1;fun<=1;fun++){
			...
			for(int i=0;i<runtimes;i++){
				...
				algorithm = new SPEA2_SDE_SBX(problem);
			    ...
			    population.printObjectivesToFile("results\\SPEA2_SDE_SBX\\SPEA2_SDE_"+problem.getName()+"_"+problem.getNumberOfObjectives()+"_T"+(i+1));
			}//for runtimes
