...
//			return false;
//	}
//	public boolean WORSE(double x, double y){
//	  
//	}
...
//			referencePoint.objectives_[j] = 1.0;
		...
		if (front.nPoints_ == 0){
			...
			hv = hv2point(front.getPoint(0),referencePoint)+hv2point(front.getPoint(1),referencePoint)+hv2point(front.getPoint(2),referencePoint)+hv2point(front.getPoint(3),referencePoint)
